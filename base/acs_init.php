...
/**
* Class to initiate the router which will initiate all of the framework.
* The router call is inside a try catch block to allow me to throw exections and to have them be caught in that block
*/
class acs_init extends acs_base {
